...
import { upsertSlider } from "@/lib/actions/admin.action"
import {
    DialogContent,
    DialogDescription,
    DialogFooter,
...
import { SliderValidation } from "../validation"
...
export function InputForm({ defaults, setOpen }: Props) {
    ...
    const form = useForm<z.infer<typeof SliderValidation>>({
        resolver: zodResolver(SliderValidation),
        defaultValues: {
            title: "",
            description: "",
            link: "",
    ...
    // Submit Form
    async function onSubmit(values: z.infer<typeof SliderValidation>) {
        setLoading(true)
        ...
        const response = await upsertSlider(values, formData)
    ...
    return (
        <DialogContent className="min-w-md md:max-w-2xl">
            <DialogHeader>
                <DialogTitle>Manage Sliders</DialogTitle>
                <DialogDescription>
                    ...
                    <div className="gap-2 grid grid-cols-1 md:grid-cols-3 py-3">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormControl>
                                        <Input placeholder="Background" {...field} />
                                    </FormControl>
                                    <FormDescription>
                                        This is the Background of Slider.
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        This is the description of Slider.
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
